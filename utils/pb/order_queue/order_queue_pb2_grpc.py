...
def add_OrderQueueServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'hello.OrderQueue', rpc_method_handlers)
...
class OrderQueue(object):
    ...
    def Enqueue(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/hello.OrderQueue/Enqueue',
    ...
    def Dequeue(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/hello.OrderQueue/Dequeue',
